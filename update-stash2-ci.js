 ...
 *   HUAHE_SOURCE         - Huahe Clash subscription URL or local source path.
...
const HUAHE_SOURCE = process.env.HUAHE_SOURCE || "https://gaga-kddoleramy.cn-shenzhen.fcapp.run/sub/7dd6390d8a51576c/clash";
...
async function main() {
  ...
  // with different protocols and endpoints, so replace all legacy SSR entries.
